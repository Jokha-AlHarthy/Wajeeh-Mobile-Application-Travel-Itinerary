...
class _TripHistoryState extends State<TripHistory> {
  /// Trip still current or upcoming (end date is today or later).
  bool _isTripUpcoming(Map<String, dynamic> t) {
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final t = trips[index];
                        final upcoming = _isTripUpcoming(t);
                        ...
                        final tripTitle =
                            rawName.isNotEmpty ? rawName : cityLine;
                        final subtitleCities =
                            rawName.isNotEmpty ? cityLine : '';
